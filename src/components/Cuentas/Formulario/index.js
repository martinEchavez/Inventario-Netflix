...
const Formulario = (props) => {
    ...
    return (
        <div>
            <button className="btn btn-danger btn-block" onClick={toggle}><strong>Agregar Cuenta</strong></button>
            <Modal isOpen={modal} toggle={toggle}>
                <ModalHeader  className="text-white bg-dark" toggle={toggle}>Regístrar Cuenta</ModalHeader>
